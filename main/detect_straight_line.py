...
def edge_tumor(img):
    ...
    cv2.imshow("i2", img)
    cv2.waitKey(0)
    img = cv2.GaussianBlur(img, (11, 11), 0) #9,9
    ####im2 = cv2.bilateralFilter(im,19,30,30)
    #im = cv2.medianBlur(im,19)
...
if __name__ == '__main__':
    ...
    files_canny = glob.glob('D:\\Project-tumor-detection\\slike\\test\\edge-operators\\canny\\*.jpg')
    ...
    files_hough = glob.glob("D:\\Project-tumor-detection\\slike\\test\\hough-trasformation\\*.jpg")
    #print("canny")
