...
image = cv2.imread(r'D:\Project-tumor-detection\preprocesiranje\preprocessed-images-gamma\657 - Copy.jpg',0)

# select some patches from grassy areas of the image
grass_locations = [(74, 80), (90, 11), (56, 18), (102, 136)]
grass_patches = []
for loc in grass_locations:
	grass_patches.append(image[loc[0]:loc[0] + PATCH_SIZE, loc[1]:loc[1] + PATCH_SIZE])

# select some patches from sky areas of the image
sky_locations = [(154, 48), (71, 73), (100, 10), (115, 30)]
sky_patches = []
